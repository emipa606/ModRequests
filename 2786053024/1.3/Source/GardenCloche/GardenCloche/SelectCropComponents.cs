...
namespace GardenCloche
{
    ...
    public class SelectCrop : ThingComp
    {
        ...
        public bool DoSpawn(int count) // Modify so it uses stackCount as param, and make it recursive if spawn size too big
        {
        ...
        public void CropSelectEvent(ThingDef crop)
        {
            ...
            p.BaseHarvestCount = (int)Math.Floor(crop.plant.harvestYield*4);
