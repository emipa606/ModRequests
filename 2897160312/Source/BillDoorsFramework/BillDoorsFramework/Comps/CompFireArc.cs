...
namespace BillDoorsFramework
{
    ...
    public class CompProperties_FireArc : CompProperties
    {
        ...
        public override IEnumerable<string> ConfigErrors(ThingDef parentDef)
        {
            ...
            if (!parentDef.rotatable && maxSpanDeviation < 180)
            {
                Log.Error($"The maxSpanDeviation of {parentDef.defName} is limited but it is not a rotatable building.");
                maxSpanDeviation = 180;
            }
        }
    }

    public interface IFireArc
    {
        void PostAdjustFireArc();
    }
}