...
namespace StatueOfColonist {
    public class Window_EditStatue : Window {
        ...
        public override void DoWindowContents(Rect inRect) {
            ...
            if (raceDefs.Count >= 2) {
                Rect rectLabelRaceOfStatue = new Rect(0f, num + 2, 150f, 28f);
                Widgets.Label(rectLabelRaceOfStatue, "StatueOfColonist.RaceOfStatue".Translate());
                Rect rectButtonRaceOfStatue = new Rect(150f, num, 200f, 28f);
                ...
                Rect rectLabelGenderOfStatue = new Rect(0f, num + 2, 150f, 28f);
                Widgets.Label(rectLabelGenderOfStatue, "StatueOfColonist.GenderOfStatue".Translate());
                Rect rectButtonGenderOfStatue = new Rect(150f, num, 200f, 28f);
            ...
            Rect rectLabelLifeStageOfStatue = new Rect(0f, num + 2, 150f, 28f);
            Widgets.Label(rectLabelLifeStageOfStatue, "StatueOfColonist.LifeStageOfStatue".Translate());
            Rect rectButtonLifeStageOfStatue = new Rect(150f, num, 200f, 28f);
            ...
            Rect rectLabelHairTypeOfStatue = new Rect(0f, num + 2, 150f, 28f);
            Widgets.Label(rectLabelHairTypeOfStatue, "StatueOfColonist.HairTypeOfStatue".Translate());
            Rect rectButtonHairTypeOfStatue = new Rect(150f, num, 200f, 28f);
            ...
            Rect rectLabelHeadTypeOfStatue = new Rect(0f, num + 2, 150f, 28f);
            Widgets.Label(rectLabelHeadTypeOfStatue, "StatueOfColonist.HeadTypeOfStatue".Translate());
            Rect rectButtonHeadTypeOfStatue = new Rect(150f, num, 200f, 28f);
            ...
            Rect rectLabelBodyTypeDefOfStatue = new Rect(0f, num + 2, 150f, 28f);
            Widgets.Label(rectLabelBodyTypeDefOfStatue, "StatueOfColonist.BodyTypeOfStatue".Translate());
            Rect rectButtonBodyTypeDefOfStatue = new Rect(150f, num, 200f, 28f);
            ...
            Widgets.Label(new Rect(0f, num + 2, 150f, 28f), "StatueOfColonist.BeardOfStatue".Translate());
            if (Widgets.ButtonText(new Rect(150f, num, 200f, 28f), Statue.Data.beardDef.LabelCap)) {
                List<FloatMenuOption> list = new List<FloatMenuOption>();
                foreach (BeardDef beardDef in DefDatabase<BeardDef>.AllDefsListForReading) {
                    Action action = delegate {
                        Statue.Data.beardDef = beardDef;
                        Statue.ResolveGraphics();
                    };
                    FloatMenuOption item = new FloatMenuOption(beardDef.LabelCap, action, MenuOptionPriority.Default, null, null, 0f, null, null);
                    list.Add(item);
                }
                if (!list.NullOrEmpty()) {
                    Find.WindowStack.Add(new FloatMenu(list));
            ...
            {
                Rect rectLabel = new Rect(0f, num + 2, 150f, 28f);
                Widgets.Label(rectLabel, "StatueOfColonist.BeardBlightnessOfStatue".Translate());
                Rect rectSlider = new Rect(150f, num, 200f, 28f);
                float previousValue = this.Statue.Data.beardBlightness;
                this.Statue.Data.beardBlightness = Widgets.HorizontalSlider(rectSlider, this.Statue.Data.beardBlightness, 0f, 1f, false, this.Statue.Data.beardBlightness.ToString(), null, null, 0.01f);
                if (previousValue != this.Statue.Data.beardBlightness) {
            ...
            if (ModsConfig.IdeologyActive) {
                Widgets.Label(new Rect(0f, num + 2, 150f, 28f), "StatueOfColonist.FaceTatooOfStatue".Translate());
                if (Widgets.ButtonText(new Rect(150f, num, 200f, 28f), Statue.Data.faceTattooDef.LabelCap)) {
                    List<FloatMenuOption> list = new List<FloatMenuOption>();
                    foreach (TattooDef tattooDef in DefDatabase<TattooDef>.AllDefsListForReading.Where(def => def.tattooType == TattooType.Face)) {
                        Action action = delegate {
                            Statue.Data.faceTattooDef = tattooDef;
                            Statue.ResolveGraphics();
                            Statue.ForceResolveWhenRendering();
                        };
                        FloatMenuOption item = new FloatMenuOption(tattooDef.LabelCap, action, MenuOptionPriority.Default, null, null, 0f, null, null);
                        list.Add(item);
                    }
                    if (!list.NullOrEmpty()) {
                        Find.WindowStack.Add(new FloatMenu(list));
                ...
                Widgets.Label(new Rect(0f, num + 2, 150f, 28f), "StatueOfColonist.BodyTatooOfStatue".Translate());
                if (Widgets.ButtonText(new Rect(150f, num, 200f, 28f), Statue.Data.bodyTattooDef.LabelCap)) {
                    List<FloatMenuOption> list = new List<FloatMenuOption>();
                    foreach (TattooDef tattooDef in DefDatabase<TattooDef>.AllDefsListForReading.Where(def => def.tattooType == TattooType.Body)) {
                        Action action = delegate {
                            Statue.Data.bodyTattooDef = tattooDef;
                            Statue.ResolveGraphics();
                            Statue.ForceResolveWhenRendering();
                        };
                        FloatMenuOption item = new FloatMenuOption(tattooDef.LabelCap, action, MenuOptionPriority.Default, null, null, 0f, null, null);
...

            {
                ...
                Rect rectButtonInit = new Rect(355f, num, 40f, 28f);
