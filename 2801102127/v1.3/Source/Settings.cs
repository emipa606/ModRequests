...
namespace ResumableJobProgress
{
	...
	{
		static readonly IEnumerable<string> listedResumingJobs = new string[]
		{
		...
		static Dictionary<string, bool> disabledResumingJobs = new();

		public static bool IsStrictIngredient => strictIngredient;
		public static bool IsDisabledDeconstruct => disabledResumingJobs["DesignatorDeconstruct"];
		public static bool IsDisabledUninstall => disabledResumingJobs["DesignatorUninstall"];
