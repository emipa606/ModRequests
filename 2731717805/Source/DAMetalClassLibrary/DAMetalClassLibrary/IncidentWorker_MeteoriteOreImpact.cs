...
{
	public class IncidentWorker_MeteoriteOreImpact : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			List<Thing> list = DefDatabase<ThingSetMakerDef>.GetNamed("DA_MeteoriteOre", true).root.Generate();
		...
		{
			int maxMineables = ThingSetMaker_MeteoriteOre.MineablesCountRange.max;
