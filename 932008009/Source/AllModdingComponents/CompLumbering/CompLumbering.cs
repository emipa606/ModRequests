    ...
    public class CompLumbering : ThingComp
    {
        ...
        public void ResolveCycledGraphic()
        {
            if (Props.cycledGraphic != null &&
                Lumberer.Drawer?.renderer?.renderTree is PawnRenderTree pawnRenderTree)
            {
                pawnRenderTree.SetDirty();
                //pawnRenderTree.nakedGraphic = Props.cycledGraphic.Graphic;
            }
        }
        ...
        {
            if (Props.cycledGraphic != null &&
                Lumberer.Drawer?.renderer?.renderTree is PawnRenderTree pawnGraphicSet)
            {
                pawnGraphicSet.SetDirty();
