...
namespace CompToggleDef
{
    public static class ToggleDefCardUtility
    {
        ...
        public static void DrawCard(Vector2 size, CompToggleDef compToggleDef)
        {
            ...
            foreach (var toggleDef in toggleDefs)
            {
                ...
                if (y >= yMin)
                {
                    ...
                    RadioButtonDraw(rowRect.width - Widgets.RadioButtonSize, y, isSelected, false);
        ...
        private static readonly Action<float, float, bool, bool> RadioButtonDraw =
            (Action<float, float, bool, bool>)AccessTools.Method(typeof(Widgets), "RadioButtonDraw")
                .CreateDelegate(typeof(Action<float, float, bool, bool>));
