...
namespace RadWorld
{
	public class GenStep_Caves : GenStep
	{
		...
		[TweakValue("0RW", 0f, 1000f)] public static float OpenTunnelsPer10k = 80f;
		[TweakValue("0RW", 0f, 1000f)] public static float ClosedTunnelsPer10k = 80f;
		[TweakValue("0RW", 0, 1000)] public static int MaxOpenTunnelsPerRockGroup = 100;
		[TweakValue("0RW", 0, 1000)] public static int MaxClosedTunnelsPerRockGroup = 100;
		[TweakValue("0RW", 0, 10)] public static float MinTunnelWidth = 1.81f;
		[TweakValue("0RW", 0, 10)] public static float WidthOffsetPerCell = 0.034f;
		[TweakValue("0RW", 0, 1)] public static float BranchChance = 0.1f;
		[TweakValue("0RW", 0, 100)] public static int AllowBranchingAfterThisManyCells = 15;
		[TweakValue("0RW", 0, 1000)] public static int MinRocksToGenerateAnyTunnel = 300;
		[TweakValue("0RW", 0, 10)] public static float DirectionChangeSpeed = 8f;
