...
namespace RimWorld
{
	public class CompSpawnerExtraRaidsThree : ThingComp
	{
		private int ticksUntilSpawn;

		public CompProperties_SpawnerExtraRaidsThree PropsSpawner => (CompProperties_SpawnerExtraRaidsThree)props;
