...
namespace RimWorld
{
	public class MechhSummon : Building
	{
		...
		public override IEnumerable<Gizmo> GetGizmos()
		{
			...
			{
				defaultLabel = "Summon a Mechanoid Cluster",
				defaultDesc = "Summons a Mechanoid Cluster, be prepared",
				icon = ContentFinder<Texture2D>.Get("UI/SummonMech2"),
				action = delegate
				{
					...
					IncidentParms incidentParms2 = storytellerComp4.GenerateParms(IncidentCategoryDefOf.ThreatBig, Find.CurrentMap);
					incidentParms2.faction = Faction.OfMechanoids;
					IncidentDefOf.MechCluster.Worker.TryExecute(incidentParms2);
				}
			};
			yield return new Command_Action
			{
