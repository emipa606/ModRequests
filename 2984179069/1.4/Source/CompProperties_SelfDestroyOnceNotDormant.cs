...
public class CompProperties_SelfDestroyOnceNotDormant : CompProperties
{
	public int ticksPerHeal;

	public CompProperties_SelfDestroyOnceNotDormant()
	{
		compClass = typeof(CompSelfDestroyOnceNotDormant);
	}
