    ...
    public class ITab_Pawn_SetApparelOrder : ITab_Pawn_Gear
    {
		...
		protected override void FillTab()
        {
            if ((Find.UIRoot as UIRoot_Play) != null && SelPawn != null && SelPawn.IsColonist || USESetApparelDrawOrderModSettings.USESetApparelDrawOrderSettings_WorkEveryPawn)
            {
                ...
                List<ApparelGraphicRecord> graphicItem = SelPawn.Drawer.renderer.graphics.apparelGraphics;
                ...
                ReorderableGroup = ReorderableWidget.NewGroup((from, to) => drawOrderChanged(ref graphicItem, from, to), ReorderableDirection.Vertical);
