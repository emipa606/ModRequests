...
namespace Vampire
{
    public class JobDriver_Embrace_Caitiff : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            foreach (Toil t in JobDriver_Feed_Caitiff.MakeFeedToils(job.def, this, GetActor(), TargetA, null, null, workLeft, DoEffect, ShouldContinueFeeding, GetActor()?.Faction != TargetA.Thing?.Faction, false))
            {
                yield return t;
            }
