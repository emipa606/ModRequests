...
namespace UseYourGun
{
    public class Base : ModBase
    {
        ...
        internal static SettingHandle<bool> experimentalAutoShoot;
        ...
        public override void DefsLoaded()
        {
            ...
            experimentalAutoShoot = Settings.GetHandle<bool>("experimentalAutoShoot", "Automatically shoot at melee threats (experimental)", "Enable experimental automatic targeting of a melee attacker (WIP)", false);
        }
