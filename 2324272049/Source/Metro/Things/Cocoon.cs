...
namespace Metro
{
    public class Cocoon : ThingWithComps, IThingHolder, IOpenable
    {
        public Cocoon()
        {
        ...
        public override void DrawAt(Vector3 drawLoc, bool flip = false)
        {
            if (this.innerContainer != null && this.innerContainer.Count > 0 && (this.ContainedThing is Pawn || this.ContainedThing is Corpse))
            {
                ...
                newDrawloc.y -= 1f;
                this.innerContainer[0].DrawAt(newDrawloc, flip);
        ...
        public override IEnumerable<FloatMenuOption> GetFloatMenuOptions(Pawn myPawn)
        {
            ...
            {
                    JobDef jobDef = MetroDefOf.Metro_SavePawnFromCocoon;
                    string label = "Metro.SavePawnFromCocoon".Translate();
        ...
        public override void Tick()
        {
            ...
            if (this.ContainedThing == null && Find.TickManager.TicksGame % 60 == 0)
            {
                this.HitPoints -= 1;
                if (this.HitPoints < 0)
                {
