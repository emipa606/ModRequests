...
namespace TakeOffIndoor
{
    public static class Harmony_FationColors
    {
        public static void PatchFactionColors(Harmony harmony)
        {
            ...
            {
                transpiler = Util.HM(typeof(Harmony_WornApparel_Trans), nameof(Harmony_WornApparel_Trans.APTranspiler));
                ...
                transpiler = Util.HM(typeof(Harmony_WornApparel_Trans),nameof(Harmony_WornApparel_Trans.BodyTypeTranspiler));
                harmony.Patch(original, null, null, transpiler);
            ...
            {
                transpiler = Util.HM(typeof(Harmony_WornApparel_Trans), nameof(Harmony_WornApparel_Trans.RAG_Transpiler));
