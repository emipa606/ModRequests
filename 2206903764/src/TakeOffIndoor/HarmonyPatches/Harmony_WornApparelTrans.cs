...
namespace TakeOffIndoor
{
    public static class Harmony_WornApparel_Trans
    {
        ...
        public static void PatchResolveApparelGraphics(Harmony harmony)
        {
            ...
            HarmonyMethod transpiler = Util.HM(typeof(Harmony_WornApparel_Trans), nameof(Harmony_WornApparel_Trans.RAG_Transpiler));
        ...
        public static void PatchWornApparelCachedAP(Harmony harmony)
        {
            ...
            HarmonyMethod transpiler = Util.HM(typeof(Harmony_WornApparel_Trans), nameof(Harmony_WornApparel_Trans.TranspilerWornApparelAP));
            harmony.Patch(original, null, null, transpiler);
