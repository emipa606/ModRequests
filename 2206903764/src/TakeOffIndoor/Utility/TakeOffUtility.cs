...
namespace TakeOffIndoor
{
    ...
    public static class ModUtil
    {
        ...
        public static bool HarIsNew = false;
        public static bool ExistJetPack = false;
        public static bool ExistBadHygiene = false;
        ...
        public static Type AlienRace_EGPW;
        public static Type JetPack_RAG_JPPP;
        public static Type BadHygiene_HRP;
        public static Type BadHygiene_JDUS;
        public static Type BadHygiene_JDGW;

        public static PropertyInfo AlienRace_EGPW_WrappedPawn;
        ...
        public static void GetOtherDllExists()
        {
            ...
            //chk HAR
            HarIsNew = Util.TypeIsExistsInAssembly("AlienRace", "AlienRace.ExtendedGraphics.ExtendedGraphicsPawnWrapper", ref AlienRace_EGPW);
            if (HarIsNew)
            {
                ExistHAR = true;
                AlienRace_EGPW_WrappedPawn = AccessTools.Property(AlienRace_EGPW, "WrappedPawn");
            }
            else
            {
            ...
            //chk bad hygiene
            ExistBadHygiene = Util.TypeIsExistsInAssembly("BadHygiene", "DubsBadHygiene.Patches.HarmonyPatches+H_RenderPawn", ref BadHygiene_HRP);

            //if (ExistBadHygiene)
            //{
            //    Util.TypeIsExistsInAssembly("BadHygiene", "DubsBadHygiene.JobDriver_UseSauna", ref BadHygiene_JDUS);
            //    Util.TypeIsExistsInAssembly("BadHygiene", "DubsBadHygiene.JobDriver_GoSwimming", ref BadHygiene_JDGW);
            //}
