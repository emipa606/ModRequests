    ...
    public class TakeOffMod : Mod
    {
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            if (TakeOffSettings.useTakeOff)
            {
                ...
                {
                    lsw.LabelDouble("ApparelLayersPrivateRoom", data.privateRoomLayer.ToString(),null, l1);
                ...
                lsw.useTranslate = false;
                lsw.LabelDouble("TOC.SleepingLayer".TranslateW("Sleeping layer."), (lsw.translateName + data.sleepingLayer.ToString()).Translate(), "TOC.SleepingLayerTooltip".TranslateW("Select the layer to display during sleep. Apparels are usually not visible in the bed."));
                lsw.useTranslate = true;
                ...
                if (ModUtil.ExistHAR)
                {
                    lsw.CheckBoxSized("TOC.PatchCanDrawAddons".TranslateW("Show latest updates"), ref TakeOffSettings.patchCanDrawAddon,
