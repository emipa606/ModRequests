...
namespace TakeOffIndoor
{
    ...
    public class ApparelList
    {
        ...
        public static Dictionary<ThingDef, VisibleMode> apparelToVisible = new Dictionary<ThingDef, VisibleMode>(); //0なし -1非表示 -2強制非表示 1強制表示
        ...
        public static bool IsInvisible(ThingDef ap,bool drafted)
        {
            if(apparelToVisible.TryGetValue(ap,out VisibleMode visible))
            {
                if (drafted)
                {
                    return visible == VisibleMode.Never;
                }
                else
                {
                    return visible <= VisibleMode.Invisible;
                }
            }
            return false;
        }
        public static bool IsForceVisible(ThingDef ap, bool drafted)
        {
            if (apparelToVisible.TryGetValue(ap, out VisibleMode visible))
            {
                if (drafted)
                {
                    return visible == VisibleMode.Force;
                }
                else
                {
                    return visible >= VisibleMode.Visible;
                }
            }
            return false;
        }
        ...
        {
            if (apparelToVisible.ContainsKey(ap))
            {
                apparelToVisible[ap] = visible;
            }
        }
        ...
        public static List<string> NeverDefNameList
        {
            get
            {
                ...
                foreach (ApparelListRecord alr in list.Where(x => x.IsNever))
                {
                    defNameList.Add(alr.thing.defName);
                }
        ...
        public static List<string> InvisibleDefNameList
        {
            ...
            {
                List<string> defNameList = new List<string>();
                foreach(ApparelListRecord alr in list.Where(x => x.IsInvisible))
                {
                    defNameList.Add(alr.thing.defName);
                }
        ...
        public static List<string> VisibleDefNameList
        {
            ...
            {
                List<string> defNameList = new List<string>();
                foreach (ApparelListRecord alr in list.Where(x => x.IsVisible))
                {
                    defNameList.Add(alr.thing.defName);
                }
        ...
        public static List<string> ForceVisibleDefNameList
        {
            get
            {
                List<string> defNameList = new List<string>();
                foreach (ApparelListRecord alr in list.Where(x => x.IsForce))
                {
                    defNameList.Add(alr.thing.defName);
                }
