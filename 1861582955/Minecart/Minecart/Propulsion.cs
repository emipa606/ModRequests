...
namespace Minecart
{
    public class CompProperties_MinecartPropulsion : CompProperties
    {
        ...
        public override IEnumerable<StatDrawEntry> SpecialDisplayStats(StatRequest req)
        {
            ...
            yield return new StatDrawEntry(StatCategoryDefOf.Building, "Acceleration", pushAccel.ToString("0.00"));
            yield return new StatDrawEntry(StatCategoryDefOf.Building, "Power", pushPower.ToString("0.00"));
            yield return new StatDrawEntry(StatCategoryDefOf.Building, "Speed", pushSpeed.ToString("0.00'c'"));
        }
    }
    ...
    public class CompMinecartPropulsion : ThingComp
    {
        ...
        public override void CompTick()
        {
            ...
            if (Throttle)
            {
                ...
                {
                    MoteMaker.ThrowAirPuffUp(Parent.DrawPos + new Vector3(0.0f, 0.5f), Parent.Map);
                    if (refuelable != null)
