...
namespace StatueOfAnimal {
    ...
    class Main {
        static Main() {
            var harmony = new Harmony("com.tammybee.statueofanimal");
    ...
    class Blueprint_Install_SpawnSetup_Patch {
        static void Postfix(Blueprint_Install __instance) {
            Building_StatueOfAnimal statue = __instance.MiniToInstallOrBuildingToReinstall.GetInnerIfMinified() as Building_StatueOfAnimal;
            if (statue != null) {
