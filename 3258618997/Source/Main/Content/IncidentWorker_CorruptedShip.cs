...
namespace Necro
{
	...
	public class IncidentWorker_CorruptedShip : IncidentWorker
	{
		...
		protected override bool TryExecuteWorker(IncidentParms parms)
		{
			...
			IntVec3 intVec;
			CellFinderLoose.TryFindSkyfallerCell(ThingDefOf.CorruptedShipLanding, map, out intVec, 14, default(IntVec3), -1, false, true, true, true, true, false, null);
			Thing thing = ThingMaker.MakeThing(ThingDefOf.CorruptedShip, null);
			bool result;
			...
			else
			{
				...
				GenSpawn.Spawn(SkyfallerMaker.MakeSkyfaller(ThingDefOf.CorruptedShipLanding, thing), intVec, map, WipeMode.Vanish);
		...
		public IncidentWorker_CorruptedShip()
		{
		}
