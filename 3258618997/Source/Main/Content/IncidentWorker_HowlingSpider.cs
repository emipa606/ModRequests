...
namespace Necro
{
    ...
    public class IncidentWorker_HowlingSpider : IncidentWorker
    {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms)
        {
            ...
            Pawn pawn = PawnGenerator.GeneratePawn(NecroDefOf.Necronoid_HowlingSpider, null);
        ...
        public IncidentWorker_HowlingSpider()
        {
        }
    }
}
