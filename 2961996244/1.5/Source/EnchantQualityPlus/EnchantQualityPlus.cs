...
namespace EnchantQualityPlus.Technomancer {
    ...
    public class Ability_IncreaseQuality : Ability {
        ...
        public override bool ValidateTarget(LocalTargetInfo target, bool showMessages = true) {
            ...
            if (Prefs.LogVerbose)
                Log.Message("EnchantQualityPlus:" +
                    "\nQuality of item: " + comp.Quality +
                    "\nMax quality castable: " + MaxQuality.GetLabel() +
                    "\nPsychich sensitivity: " + Caster.GetStatValue(StatDefOf.PsychicSensitivity) +
                    "\nActive setting: " + Settings.ChoiceOfMechanic);
        ...
        public override float GetPowerForPawn() {
            if (Settings.ChoiceOfMechanic == "ScalingSquished")
                return pawn.GetStatValue(StatDefOf.PsychicSensitivity) switch {
                    ...
                    <= 2.0f => (int)QualityCategory.Excellent,
                ...
                return pawn.GetStatValue(StatDefOf.PsychicSensitivity) switch {
                    ...
                    <= 3.5f => (int)QualityCategory.Masterwork,
