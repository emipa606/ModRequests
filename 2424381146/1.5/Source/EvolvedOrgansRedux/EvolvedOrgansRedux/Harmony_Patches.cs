...
namespace EvolvedOrgansRedux {
    ...
    public static class HarmonyPatches {
        ...
        private static readonly Harmony harmony = new(Singleton.Instance.Settings.Mod.Content.Name);
        static HarmonyPatches() {
            PatcherPostFix(typeof(AgeInjuryUtility), nameof(AgeInjuryUtility.RandomHediffsToGainOnBirthday), nameof(RandomHediffsToGainOnBirthday_Postfix), [typeof(Pawn), typeof(int)]);
        ...
        //        Log.Error(limbCoreTag.defName + " " + __result);
