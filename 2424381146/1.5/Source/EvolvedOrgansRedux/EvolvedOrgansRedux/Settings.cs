...
namespace EvolvedOrgansRedux {
    public class Settings : ModSettings {
        ...
        public System.Collections.Generic.List<string> ChoicesOfWorkbenches = ["Evolved Organs Redux"];
        public System.Collections.Generic.List<int> ChoicesForAmountOfBodyParts = [2, 4, 6, 8];
