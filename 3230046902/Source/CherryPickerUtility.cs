...
namespace CherryPicker
{
    ...
    internal static class CherryPickerUtility
	{
        ...
        public static List<ModContentPack> ActiveMods
        {
            get
			{ 

				return cachedActiveMods ??= [.. allDefs.Select((Def def) => def.modContentPack).ToHashSet()]; ;
            }
        }
        public static List<ModContentPack> cachedActiveMods;
