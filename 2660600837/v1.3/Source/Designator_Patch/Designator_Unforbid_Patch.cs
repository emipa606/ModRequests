...
namespace FilterableDesignator
{
	...
	{
		// singleton
		private readonly static Designator_Unforbid_Patch instance = new Designator_Unforbid_Patch();
		...
		private protected override void BuildFloatMenuOption(Designator instance, Event ev)
		{
			...
			var floatMenuList = new List<(UnforbidMode, ThingDef, string, Texture2D)>
			{
