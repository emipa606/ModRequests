...
namespace FilterableDesignator
{
	...
	{
		// singleton
		private readonly static Designator_PlantsHarvest_Patch instance = new Designator_PlantsHarvest_Patch();
		...
		private protected override void BuildFloatMenuOption(Designator instance, Event ev)
		{
			...
			var floatMenuList = new List<(PlantsHarvestMode, ThingDef, string, Texture2D)>
			{
