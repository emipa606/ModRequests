...
namespace FilterableDesignator
{
	...
	{
		// singleton
		private readonly static Designator_Deconstruct_Patch instance = new Designator_Deconstruct_Patch();
		...
		private protected override void BuildFloatMenuOption(Designator instance, Event ev)
		{
			...
			var floatMenuList = new List<(DeconstructMode, ThingDef, string, Texture2D)>
			{
