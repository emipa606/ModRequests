...
namespace CustomPlaystylePresets
{
	public class Dialog_SetPresetName : Dialog_Rename
	{
		...
		protected override void SetName(string name)
		{
			...
			DrawStorytellerSelectionInterface_NewTemp_Patch.customStorage = presetStorage;
			DrawStorytellerSelectionInterface_NewTemp_Patch.customDifficultyDef = customDifficultyDef;
