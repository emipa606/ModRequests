...
namespace PreemptiveStrike.Harmony
{
    ...
    /*
    [HarmonyPatch(typeof(IncidentWorker_Ambush_ManhunterPack), "TryExecuteWorker")]
    static class Patch_IncidentWorker_Ambush_ManhunterPack_TryExecuteWorker
    {
        [HarmonyPrefix]
        static bool Prefix(IncidentWorker_Ambush_ManhunterPack __instance, ref bool __result, IncidentParms parms)
        {
			if (PES_Settings.DebugModeOn)
			{
