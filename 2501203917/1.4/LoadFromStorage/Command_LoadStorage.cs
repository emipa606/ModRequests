...
{
	public class Command_LoadStorage : Command
	{
		...
		public override void ProcessInput(Event ev)
		{
			...
			Dialog_LoadFromStorage dialog_LoadTransporters = new Dialog_LoadFromStorage(transporter.Map, group);
		...
		{
			Command_LoadStorage command_other = (Command_LoadStorage)other;
