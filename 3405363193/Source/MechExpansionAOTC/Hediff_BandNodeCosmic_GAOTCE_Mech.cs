...
namespace RimWorld
{
    public class Hediff_BandNodeCosmic_GAOTCE_Mech : Hediff
    {
        ...
        private int bandwidthPerNode = 8;
        ...
        public void RecacheBandNodes()
        {
            ...
            {
                foreach (Building item in maps[i].listerBuildings.AllBuildingsColonistOfDef(GreenDefOf.BandNodeCosmic_GAOTCE_Mech))
                {
