...
namespace RimWorld
{
    public class Hediff_BandNodeStable_GAOTCE_Mech : Hediff
    {
        ...
        private int bandwidthPerNode = 32;
        ...
        public void RecacheBandNodes()
        {
            ...
            {
                foreach (Building item in maps[i].listerBuildings.AllBuildingsColonistOfDef(GreenDefOf.BandNodeStable_GAOTCE_Mech))
                {
