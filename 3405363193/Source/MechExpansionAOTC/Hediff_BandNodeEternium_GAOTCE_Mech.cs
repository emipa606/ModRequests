...
namespace RimWorld
{
    public class Hediff_BandNodeEternium_GAOTCE_Mech : Hediff
    {
        ...
        private int bandwidthPerNode = 16;
        ...
        public void RecacheBandNodes()
        {
            ...
            {
                foreach (Building item in maps[i].listerBuildings.AllBuildingsColonistOfDef(GreenDefOf.BandNodeEternium_GAOTCE_Mech))
                {
