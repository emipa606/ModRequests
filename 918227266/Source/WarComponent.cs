    ...
    public class WarComponent : WorldComponent
    {
        ...
        {        
                ...
                !hostilityDeclared)
            {
                ...
                if (
                    Find.FactionManager.
                        FirstFactionOfDef(facDef: 
                            DefDatabase<FactionDef>.GetNamedSilentFail(defName: "PJ_RebelFac")) 
                                is { } rebelFaction &&
                    Find.FactionManager.
                        FirstFactionOfDef(
                                ...
                                is { } impFaction)
                {
                    ...
                    Find.LetterStack.ReceiveLetter(
                        label: "PJ_WarDeclared".Translate(),
                        text: "PJ_WarDeclaredDesc".Translate(rebelFaction.def.label, impFaction.def.label),
                        textLetterDef: DefDatabase<LetterDef>.GetNamed(defName: "PJ_BadUrgent"),
                        lookTargets: null,
                        relatedFaction: rebelFaction,
                        quest: null,
