...
namespace FinishingTouchesByTheBestBuilder
{
    ...
    internal static class UIHelper
    {
        ...
        public static float WriteFixedSectionTitleBox(Rect inRect, string title, Rect innerRect, Func<Rect, float> innerAction, GameFont orgFont, GameFont newFont = GameFont.Medium, bool titleBg = true)
        {
            if (titleBg)
            {
                Widgets.DrawTitleBG(inRect);
            ...
            Widgets.DrawTextureFitted(buttonRect, TexButton.Collapse, 1f);
            Text.Font = newFont;
